...
func ProcessPosition(Data : MapData, pos : Vector3i, _r : RandomNumberGenerator = null) -> void:
	...
	if (cell.type == CellData.CELLTYPE.LAVA):
		...
		collision.Name = InteractionCollisionShape.AreaNames.Lava
